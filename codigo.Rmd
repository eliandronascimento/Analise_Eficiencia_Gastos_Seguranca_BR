---
title: "DEA COM DADOS DE 2018 - MONOGRAFIA"
author: "Eliandro"
date: "14/11/2019"
...
IMPORTAR BASE DE DADOS: importa a base de dados e a nomeia como "SEGURANCA_2018".
```{r}

DADOS <- read_excel("~/DESENVOLVIMENTO_PESSOAL/ECONOMIA/PROJETO_MONOGRAFIA_GITHUB/DADOS.xlsx")
View(DADOS)
```
VARIÁVEIS
...
x = Despesa per capita realizada com a Função Segurança Pública - Em reais
constantes de 2017

y1 = Mortes Violentas Intencionais-MVI (Homicídio Doloso; Latrocínio; Lesão
Corporal seguida de Morte.)-Taxa por 100 mil habitantes

y2 = Roubo e Furto de Veículo - Taxa por 100 mil veículos (SEM DADOS PARA
RORAIMA)

y3 = Estupro - taxa por 100 mil habitantes

y4 = Tráfico de Entorpecentes - taxa por 100 mil habitantes (SEM DADOS PARA
RORAIMA)

y5 = Roubo (total) - taxa por 100 mil habitantes (SEM DADOS PARA RORAIMA)

z1 = Proporção de jovens negros na faixa etária de 15-29 anos de idade - % da
população
...
Calcula o inverso dos ìndices de criminalidade devido a querer reduzir-las e calcula a
variável x3(número de policiais):
```{r}
